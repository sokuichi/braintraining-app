      ...
      function setPointerFromEvent(event) {
        ...
        if (event.target !== pointerState.lastTarget) {
          pointerState.lastTarget = event.target;
      ...
      function applySettings() {
        ...
        if (!state.settings.customCursor) document.body.classList.remove("cursor-ready");
      ...
      function bindEvents() {
        ...
        on(document, "mousemove", setPointerFromEvent, "mouse move");
        on(document, "mouseover", setPointerFromEvent, "mouse over");
