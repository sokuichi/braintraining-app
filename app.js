      ...
      function setPointerFromEvent(event) {
        ...
        const modeTarget = document.elementFromPoint(latest.clientX, latest.clientY) || event.target;
      ...
      function syncCustomCursor() {
        ...
        if (distance > 120 || state.settings.lowMotion) {
          ...
          pointerState.followX += dx * follow;
          pointerState.followY += dy * follow;
        }
      ...
      function bindEvents() {
        ...
        on(document, "pointerrawupdate", setPointerFromEvent, "cursor raw pointer", { passive: true });
