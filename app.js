      ...
      function hitTarget(event) {
        ...
        triggerVfx(aimRound.streak > 0 && aimRound.streak % 5 === 0 ? "combo" : "hit", { x: event.clientX, y: event.clientY });
      ...
      function missTarget(event) {
        ...
        triggerVfx("wrong", { x: event.clientX, y: event.clientY });
        playSfx("wrong");
        updateAimHud();
      }
      ...
      function answerQuestion(button, option) {
        ...
        triggerVfx(correct ? "correct" : "wrong", elementCenter(button));
