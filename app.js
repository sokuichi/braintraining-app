      ...
      const TYPEWRITER_IDENTITY_VERSION = "typewriter-v1";
      ...
      const defaultState = {
        ...
        settings: {
          ...
          vfx: 2,
          theme: "typewriter",
          identityVersion: TYPEWRITER_IDENTITY_VERSION
        },
        modules: {
      ...
      function loadState() {
        ...
        if (!saved?.settings?.identityVersion) {
          loaded.settings.theme = "typewriter";
          loaded.settings.identityVersion = TYPEWRITER_IDENTITY_VERSION;
        }
      ...
      function themeLabel(theme) {
        return visualThemes[theme] || theme || "P22 Typewriter";
      }
      ...
      function applySettings() {
        ...
        document.body.dataset.theme = state.settings.theme || "typewriter";
        ...
        $("#settingThemeMode").value = state.settings.theme || "typewriter";
        $("#themeModeLabel").textContent = themeLabel(state.settings.theme || "typewriter");
        ...
        $("#terminalThemeSelect").value = state.settings.theme || "typewriter";
      ...
      function saveSettingsFromForm() {
        ...
        state.settings.identityVersion = TYPEWRITER_IDENTITY_VERSION;
      ...
      function answerTimeLimit(key) {
        ...
        return Math.round(clamp((limits[key] || 30000) * loadBonus, quickTimer ? 420 : 9000, longTimer ? 240000 : 90000));
      }
      ...
      function timerText(module, remainingMs) {
        ...
        const label = { aim: "target", questions: "question", memory: "card", focus: "ink", creativity: "sprint", analogy: "mapping", spatial: "chain", calibration: "confidence", systems: "systems", rrt: "relation" }[module] || "timer";
      ...
      function memoryConfig() {
        ...
        return {
          ...
          lure,
          interference,
          matchRate: [0.44, 0.56, 0.68][lure] || 0.56,
          lureRate: [0.12, 0.22, 0.34][lure] || 0.22,
      ...
      function terminalHelp() {
        ...
        terminalWriteBlock("Control commands", [
          ...
          "theme typewriter|geist|classic|matrix|neon|contrast, vfx off|low|arcade|max",
      ...
      function terminalStatsLines() {
        ...
        return [
          ...
          `program ${state.settings.hardMode ? "hard" : "normal"} | depth ${["", "focused", "deep", "extreme"][state.settings.problemDepth]} | load ${["short", "standard", "heavy"][state.settings.sessionLoad]} | theme ${themeLabel(state.settings.theme)} | vfx ${["off", "low", "arcade", "max"][state.settings.vfx]}`
        ];
      }
      ...
      function runTerminalCommand(raw) {
        ...
        if (verb === "theme") {
          if (!setThemeMode(second)) {
            terminalWrite("Usage: theme typewriter | geist | classic | matrix | neon | contrast", "error");
            playSfx("wrong");
            return;
          }
