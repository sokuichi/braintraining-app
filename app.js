      ...
      function terminalStatsLines() {
        ...
        return [
          ...
          `program ${state.settings.hardMode ? "hard" : "normal"} | depth ${["", "focused", "deep", "extreme"][state.settings.problemDepth]} | load ${["short", "standard", "heavy"][state.settings.sessionLoad]}`
        ];
      }
